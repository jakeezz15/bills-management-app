...
/** Default blue — prefer `useDashboardStyles()` for live accent. */
export const dashboard = createDashboardStyles(defaultTheme);

export function useDashboardStyles() {
    const { theme } = useTheme();
    return useMemo(() => createDashboardStyles(theme), [theme]);
}
